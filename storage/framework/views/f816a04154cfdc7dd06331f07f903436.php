        ...
        <div class="comanda-layout">
            ...
            <div class="comanda-left">
                ...
                <div id="step1">
                    ...
                    <?php $__currentLoopData = ['bauturi_calde' => $bauturiCalde, 'cocktailuri' => $cocktailuri, 'lemonades' => $lemonades, 'deserturi' => $deserturi, 'inghetata' => $inghetata]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $categorisita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="comanda-products <?php echo e($key != 'bauturi_calde' ? 'hidden' : ''); ?>" id="cat_<?php echo e($key); ?>">
                            <?php $__currentLoopData = $categorisita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="comanda-product-item">
                                    ...
                                    <button type="button" class="btn-add-product" onclick="addToCart(<?php echo e($produs->id); ?>, '<?php echo e(addslashes($produs->nume)); ?>', <?php echo e($produs->pret); ?>)">
