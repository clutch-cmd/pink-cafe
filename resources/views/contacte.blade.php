...
<div class="contacte-page">
    ...
    <div class="contacte-grid">
        ...
        <div class="contacte-card">
            <div class="contacte-card-icon"><i class="fa-solid fa-phone" ></i></div>
            <h3>Telefon</h3>
            <a href="tel:079043047" class="contacte-phone">0790 43 047</a>
        </div>

        <div class="contacte-card">
            <div class="contacte-card-icon"><i class="fa-solid fa-location-dot footer-contact-icon"></i> </div>
            <h3>Adresă</h3>
            <p>Cahul, MD</p>
        ...
        <div class="contacte-card">
            <div class="contacte-card-icon"><i class="fa-regular fa-clock" style="color: rgb(0, 0, 0);"></i></div>
            <h3>Program</h3>
            <p>Luni - Duminică</p>
        ...
        <div class="contacte-card contacte-card-social">
            <div class="contacte-card-icon"><i class="fa-solid fa-mobile"></i>
          </div>
            <h3>Social Media</h3>
